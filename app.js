...
function loadEntry(e,dup=false){
 ...
 if(typeof getTrainingType==='function'){
   const t=e.trainingType||'session';
   const radio=document.querySelector(`input[name="trainingType"][value="${t}"]`);
   if(radio)radio.checked=true;
   const d=document.getElementById('entryDuration');
   if(d)d.style.display=(t==='walk')?'none':'';
 }
